...
function aquila_the_excerpt_more($more = ''){
	if ( ! is_single()) {
		$more = sprintf('<button class="btn btn-info"><a class="aquila-read-more text-white" href="%1$s">%2$s</a></button>',
...
function aquila_pagination(){
	...
	$args = [
		'before_page_number'	=> '<span class="btn border border-secondary mb-2 mr-2">',
		'after_page_number'	=>'</span>'
	];

	printf('<nav class="aquila-pagination clearfix">%1$s</nav>',
